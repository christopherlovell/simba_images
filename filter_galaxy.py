...
output_dir='/ufrc/narayanan/c.lovell/simba/m25n512/out/'

# for snap in sb.snaps:
snap_idx = int(sys.argv[1])
# snap = sb.lightcone_snaps[::-1][snap_idx]
snap = str(snap_idx)
print(snap)
input("Press Enter to continue...")

ds = sb.get_sim_file(snap, snap_str='snapshot_%s.hdf5')
